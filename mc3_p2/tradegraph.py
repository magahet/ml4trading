...
def parse_args():
    parser = argparse.ArgumentParser(description='Test strategy')
    parser.add_argument('orders', help='orders file')
    parser.add_argument('start_date', help='Start Date')
    parser.add_argument('end_date', help='End Date')
    parser.add_argument('-s', '--start', default=10000, type=int,
...
if __name__ == "__main__":
    args = parse_args()
    test_run(args.start_date, args.end_date, args.orders, args.start)
